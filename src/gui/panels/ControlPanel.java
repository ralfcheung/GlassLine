...
public class ControlPanel extends JPanel implements TReceiver
{
	...
	public final static Dimension size = new Dimension(600, 450);
	...
	public ControlPanel(FactoryPanel fPanel, Transducer fTransducer)
	{
		...
		glassInfoPanel = new GlassInfoPanel(this, transducer);
		...
		selectTabbedPanel.add("Glass Info", glassInfoPanel);
		selectTabbedPanel.add("Agent Traces", tracePanel);
...
*/
		...
		colorLines.setPreferredSize(new Dimension(350, 5));
		...
		//JSplitPane splitPane = new JSplitPane(JSplitPane.HORIZONTAL_SPLIT, selectTabbedPanel, infoTabbedPanel);
