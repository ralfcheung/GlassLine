 ...
 * 1. broken conveyor - clicking on a conveyor will make it stop, and it won't start until you click on it again.
 * 						this should make all conveyors before it stop
 * 2. broken online component - same as above
 * 3. broken workstation - workstation cannot accept glass, so popup should not pass glass to this workstation.
 * 							if glass does not get an operation done to it that it needs, the factory should detect it right away
 * 							and take some sort of action (stop factory? destroy glass?)
 * 4.
 * 5.
 * 6.
 * 7.
